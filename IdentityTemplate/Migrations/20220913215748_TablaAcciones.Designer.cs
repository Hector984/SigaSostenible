...
namespace IdentityTemplate.Migrations
{
    ...
    [Migration("20220913215748_TablaAcciones")]
    partial class TablaAcciones
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityTemplate.Areas.Identity.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("NivelSeguimientoId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_usuario_nivel_seg")
                        .HasColumnOrder(17);
                    ...
                    b.Property<int?>("TipoInstitucionId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_usuario_institucion")
                        .HasColumnOrder(14);
                    ...
                    b.HasIndex("TipoInstitucionId")
                        .HasDatabaseName("idx05_usuario");

                    b.ToTable("tb_usuario", (string)null);
                });

            modelBuilder.Entity("IdentityTemplate.Models.Catalogos.AreaIncidencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_area_incidencia");
                    ...
                    b.Property<string>("Descripcion")
                        .HasMaxLength(256)
                        .HasColumnType("varchar")
                        .HasColumnName("ln_descripcion_area");

                    b.HasKey("Id")
                        .HasName("id_n_area_incidencia");

                    b.ToTable("tb_cat_area_incidencia", (string)null);
                });

            modelBuilder.Entity("IdentityTemplate.Models.Catalogos.Impacto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_impacto");
                    ...
                    b.Property<string>("Descripcion")
                        .HasMaxLength(256)
                        .HasColumnType("varchar")
                        .HasColumnName("ln_descripcion_impacto");

                    b.HasKey("Id")
                        .HasName("id_n_impacto");

                    b.ToTable("tb_cat_impacto", (string)null);
                });
            ...
            modelBuilder.Entity("IdentityTemplate.Models.Catalogos.TipoInstitucion", b =>
                {
                    ...
                    b.HasIndex("NombreDeInstitucion")
                        .IsUnique()
                        .HasDatabaseName("idx01_tipo_institucion");

                    b.ToTable("tb_cat_tipo_institucion", (string)null);
                });

            modelBuilder.Entity("IdentityTemplate.Models.Catalogos.TipoSoprte", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_tipo_soporte");
            ...
            modelBuilder.Entity("IdentityTemplate.Models.Catalogos.UnidadMeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_unidad_meta");
            ...
            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.Accion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_accion");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));

                    b.Property<int>("LineaEstrategicaId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_lin_estrate_accion");

                    b.Property<string>("Nombre")
                        .HasColumnType("text")
                        .HasColumnName("ln_desc_accion");

                    b.HasKey("Id")
                        .HasName("id_n_accion");

                    b.HasIndex("LineaEstrategicaId")
                        .HasDatabaseName("idx01_accion");

                    b.ToTable("tb_cat_accion", (string)null);
                });

            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.EjeTematico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_eje_tematico");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));

                    b.Property<string>("Nombre")
                        .HasColumnType("text")
                        .HasColumnName("ln_descripcion_eje");

                    b.Property<int>("PoliticaId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_politica_eje_tematico");

                    b.HasKey("Id")
                        .HasName("id_n_eje_tematico");

                    b.HasIndex("PoliticaId")
                        .HasDatabaseName("idx01_eje_tematico");

                    b.ToTable("tb_cat_eje_tematico", (string)null);
                });

            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.LineaEstrategica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_n_linea_estrategica");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));

                    b.Property<int>("EjeTematicoId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_eje_tematico_lin_estrate");

                    b.Property<string>("Nombre")
                        .HasColumnType("text")
                        .HasColumnName("ln_desc_estrategia");

                    b.HasKey("Id")
                        .HasName("id_n_linea_estrategica");

                    b.HasIndex("EjeTematicoId")
                        .HasDatabaseName("idx01_linea_estrateg");

                    b.ToTable("tb_cat_linea_estrategica", (string)null);
                });
            ...
            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.Accion", b =>
                {
                    b.HasOne("IdentityTemplate.Models.VariableSesguimiento.LineaEstrategica", "LineaEstrategica")
                        .WithMany("Acciones")
                        .HasForeignKey("LineaEstrategicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_lin_estrategica_accion");
            ...
            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.EjeTematico", b =>
                {
                    b.HasOne("IdentityTemplate.Models.Catalogos.Politica", "Politica")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_politica_eje_tematico");
            ...
            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.LineaEstrategica", b =>
                {
                    b.HasOne("IdentityTemplate.Models.VariableSesguimiento.EjeTematico", "EjeTematico")
                        .WithMany("LineasEstrategicas")
                        .HasForeignKey("EjeTematicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_eje_tematico_lin_estrate");

                    b.Navigation("EjeTematico");
                });
            ...
            modelBuilder.Entity("IdentityTemplate.Models.VariableSesguimiento.EjeTematico", b =>
                {
                    b.Navigation("LineasEstrategicas");
                });
